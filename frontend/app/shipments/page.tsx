              ...
              return (
                <div className={`border border-slate-700 rounded-xl overflow-hidden mx-auto transition-all duration-300 ${previewWidthClass}`} style={{ background: "linear-gradient(180deg, #E8ECF0 0%, #D1D5DB 50%, #C4C9CF 100%)" }}>
                  ...
                  <div className="p-2.5 relative text-center">
                    ...
                    {/* Secret PIN Zone */}
                    {(() => {
                      const activePinModal = showStickerDownload.innerSecret || createdInnerSecret || ("RCVR-" + (showStickerDownload.packageId.startsWith("0x") ? showStickerDownload.packageId.slice(2, 10) : showStickerDownload.packageId.slice(0, 8)).toUpperCase());
                      return (
